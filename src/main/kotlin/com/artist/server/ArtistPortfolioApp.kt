...
import com.artist.server.config.ApplicationProperties
import com.artist.server.config.CRLFLogConverter
...
class ArtistPortfolioApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ArtistPortfolioApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ArtistPortfolioApp::class.java)
