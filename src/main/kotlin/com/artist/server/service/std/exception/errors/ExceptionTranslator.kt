...
import com.artist.server.service.core.exception.UsernameAlreadyUsedException
...
// HD01001
    ...
    @ExceptionHandler
    fun handleEmailAlreadyUsedException(ex: com.artist.server.service.core.exception.EmailAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    @ExceptionHandler
    fun handleInvalidPasswordException(ex: com.artist.server.service.core.exception.InvalidPasswordException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    @ExceptionHandler
    fun handleBadRequestApiException(
        ex: BadRequestApiException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? =
        create(
            ex, request,
            HeaderUtil.createFailureAlert(applicationName, false, null, ex.errorKey, ex.message)
        )
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.artist.server").any { it == message }
}
