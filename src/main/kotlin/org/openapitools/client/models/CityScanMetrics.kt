...
data class CityScanMetrics(

    @Json(name = "units")
    val units: kotlin.Int? = null,

    @Json(name = "facet")
    val facet: CityScanMetrics.Facet? = null,
    ...
    @Json(name = "metrics")
    val metrics: kotlin.collections.List<CityScanMetric>? = null,

    @Json(name = "other_metrics")
    val otherMetrics: OtherScanMetrics? = null
